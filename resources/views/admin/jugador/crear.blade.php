    ...
    <div class="offset-sm-3 col-sm-6">
        <form method="POST" action="{{!empty($jugador)?action('JugadorController@update',["id"=>$jugador->id]):action('JugadorController@store')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input required type="text" name="nombre" class="form-control" placeholder="" value="{{!empty($jugador)?$jugador->nombre:"" }}" >
            </div>
            <div class="form-group">
                <label>Género</label>
            ...
            <div class="form-group">
                ...
                <input required type="text" name="usuario" class="form-control" placeholder="" value="{{!empty($usuario)?$usuario->username:"" }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input required type="date" name="nacimiento" class="form-control" value="{{!empty($jugador)?$jugador->fechaNac:"" }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input required type="text" name="curp" class="form-control" placeholder="" value="{{!empty($jugador)?$jugador->documento_identidad:"" }}">
            </div>
            ...
            <div class="form-group">
                ...
                <select required class="form-control" name="id_equipo">
            ...
            <div class="form-group">
                ...
                <input required type="text" name="dorsal" class="form-control" placeholder="" value="{{!empty($jugador)?$jugador->numero:"" }}">
            </div>
