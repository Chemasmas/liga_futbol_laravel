				               ...
				               <div class="position-center-x full-width">
								<div class="container">
									<div class="banner-caption style-1 p-white h-white pull-right">
										...
										<a class="btn lg red-btn animated fadeInRight delay-3s" href="nextmatchs.html"><i>+</i>leer mas</a>
									</div>
								</div>
							</div>
			            </div> 
				               ...
				               <div class="position-center-x full-width">
								<div class="container">
									<div class="banner-caption style-2 p-white h-white pull-left">
										...
										<a class="btn lg red-btn animated fadeInRight delay-3s" href="statistics.html"><i>+</i>leer mas</a>
									</div>
								</div>
							</div>
			            </div> 
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
						  <div class="row">
								...
								<div class="col-sm-8 col-xs-7 r-full-width">
								  <h3><span><em class="red-color">JORNADAS </em>ACTUALES</span><a class="view-all pull-right" href="nextmatchs.html">Ver mas<em class="fa fa-angle-double-right"></em></a></h3>
