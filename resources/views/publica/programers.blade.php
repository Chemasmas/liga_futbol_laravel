						...
						<div class="team-column">
							...
							<div class="team-detail">
								...
								<div class="detail-inner">
									...
									<ul>
										<li>30</li>
										<li>jcorona@clubmundet.com</li>
										<li>044 5534943920</li>
										<li>Club Mundet</li>
										<li>
											<ul class="social-icons">
												<li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="team-column">
							...
							<div class="team-detail">
								...
								<div class="detail-inner">
									...
									<ul>
										<li>30</li>
										<li>quirozmm@cvh.edu.mx</li>
										<li>044 5544743819</li>
										<li>Colegio Vista Hermosa</li>
										<li>
											<ul class="social-icons">
												<li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
												<li><a class="twitter" href="#"><i class="fa fa-twitter"></i></a></li>
						...
						<div class="team-column">
							...
							<div class="team-detail">
								...
								<div class="detail-inner">
									...
									<ul>
										<li>30</li>
										<li>gosl_88@hotmail.com</li>
										<li>044 5583692091</li>
										<li>Cruz Azul SF</li>
										<li>
											<ul class="social-icons">
												<li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
						...
						<div class="team-column">
							...
							<div class="team-detail">
								...
								<div class="detail-inner">
									...
									<ul>
										<li>30</li>
										<li>gaon_azul@hotmail.com</li>
										<li>044 5529383622</li>
										<li>Santos</li>
										<li>
											<ul class="social-icons">
												<li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
